...
bot.on('message', message => {
  ...
  if(msg.startsWith (prefix + "scout")) {
      ...
      switch (random) {
        ...
        case 11: message.channel.send ({files:["./images/yuki_xmasmagic_ssr.png"]}); break;     
        ...
        case 25: message.channel.send ({files:["./images/yuki_xmasrock_ssr.png"]}); break;
...
bot.on("message", async message => {
  ...
  if(cmd ===`${prefix}help`){
    ...
    .addField("Basic y!commands:", "mafia (alias:maf) || leaf || ryo || order || rank || watchout")
